...
def contar_y_convertir():
    while True:
        ...
        # Bloque de conteo (Línea por línea absoluto)
        print("===========================================")
        print("                  CONTEO                   ")
        print("===========================================\n")
        ...
        for paso in range(1, C + 1):
            ...
            # Renderizado incondicional en cada iteración
            valor_actual = "".join([ALFABETO[d] for d in reversed(digitos)])
            valor_limpio = valor_actual.lstrip(ALFABETO[0]) or ALFABETO[0]
            
            print(f"Progreso: {paso}/{C} | Valor en Base {N}: {valor_limpio}")
